...
<div class="cotainer">
    <form class="form-horizontal" method="POST" action="{{ route('company.store') }}">
        ...
        <input name="company_id" type="hidden" value="{{$id}}">
        ...
        <div class="form-group{{ $errors->has('company_address') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_address" type="text" class="form-control" name="company_address" value="{{ $company->company_address }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('company_pin') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_pin" type="text" class="form-control" name="company_pin" value="{{ $company->company_pin }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('company_city') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_city" type="text" class="form-control" name="company_city" value="{{ $company->company_city }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('company_state') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                ...
                @foreach ($statelist as $state)
                    @if($state->state_id == $company->company_state)
        ...
        <div class="form-group{{ $errors->has('company_country') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                ...
                @foreach ($countrylist as $country)
                    @if($country->country_id == $company->company_country)
        ...
        <div class="form-group{{ $errors->has('company_gstinno') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_gstinno" type="text" class="form-control" name="company_gstinno" value="{{ $company->company_GSTIN }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('company_CIN') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_CIN" type="text" class="form-control" name="company_CIN" value="{{ $company->company_CIN }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('company_PAN') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_PAN" type="text" class="form-control" name="company_PAN" value="{{ $company->company_PAN }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('company_contact_person') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_contact_person" type="text" class="form-control" name="company_contact_person" value="{{ $company->company_contact_person }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('company_contact_no') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="company_contact_no" type="text" class="form-control" name="company_contact_no" value="{{ $company->company_contact_no }}" required autofocus>
