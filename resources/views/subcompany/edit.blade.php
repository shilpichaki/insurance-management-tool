        ...
        <div class="panel-body">
            <form method="post" action="{{ route('subcompany.update')}}" > 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="company_name" class="form-control" id="company_name" value ="{{$subcompany->s_company_name}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="feedback_day" class="form-control" id="feedback_day" value ="{{$subcompany->s_avg_feedback_day}}" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="email"  name="company_email" class="form-control" id="company_email" value ="{{$subcompany->s_company_email }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text"  name="company_address" class="form-control" id="company_address" value ="{{$subcompany->s_company_address}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text"  name="company_pin"  class="form-control" id="company_pin" value ="{{$subcompany->s_company_pin}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="company_city" class="form-control" id="company_city" value ="{{$subcompany->s_company_city}}">
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('company_state') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        ...
                        @foreach ($state_data as $state)
                            @if($state->state_id == $subcompany->s_company_state)
                ...
                <div class="form-group{{ $errors->has('company_country') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        ...
                        @foreach ($country_data as $country)
                            @if($country->country_id == $subcompany->s_company_country)
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="company_gstinno" class="form-control" id="company_gstinno" value ="{{$subcompany->s_company_GSTIN }}" >
                    </div>
                </div>
