$(function() {
    ...
    $('.tell_index td').hover(function () {
        ...
        $(this).closest('tr').find("td:first").addClass('highlight_coordinate');
        $(this).closest('tbody').find('tr').find('th:eq('+td_index+')').addClass('highlight_coordinate_th');

        var current_row_length = $(this).closest('tr').find('td').length;
