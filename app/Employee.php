...
class Employee extends Model
{
    ...
    {
        return $this->hasOne('App\UserActivation', 'employee_id', 'emp_id');
    }

    public function policies()
    {
        return $this->hasMany('App\Policy', "employee_id", "emp_id");
    }

    // public function employeesWithIntroducerCode() {
    //     return $this->belongsTo('App\UserActivation', 'emp_introducer_code', 'user_activation_id');
    // }

    // public function user()
    // {
    //     return $this->hasOne('App\User', 'empid', 'emp_id');
    // }
