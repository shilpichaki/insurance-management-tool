...
class CreatePaymentRecivedAgainstDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_payment_recived_against_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_payment_recived_against_details');
    }
}
